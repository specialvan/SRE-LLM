...
- Dirty-tree follow-up: quality-gate counts are now generated by `scripts/quality_gate_counts.py`; current-facing `PR-REQUIREMENTS.md` / V2 HTML quality gates now say 96 after `python -m scripts.quality_gate_counts`.
