...
| RES-017 | Generated quality-gate counts | `scripts/quality_gate_counts.py` updates current-facing pytest counts after a real full-suite pytest pass; current generated count is 96. |
