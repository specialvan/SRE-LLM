...
| [`docs/codex-review/QUALITY_GATES.md`](../docs/codex-review/QUALITY_GATES.md) | Current canonical command gates and observed local snippets |
| [`docs/opus-review/HANDOFF.md`](../docs/opus-review/HANDOFF.md) | Current Opus first-read handoff; use its `Git Review Scope Snapshot` and refresh `git status --short --branch --untracked-files=all` plus `git ls-files --others --exclude-standard` for dirty/untracked review scope |
...
| [`claude-review/docs/v2026-05-31/README.md`](../claude-review/docs/v2026-05-31/README.md) | Historical Opus v2026-05-31 returned review context; use live ledgers for current M1/M2 status |
...
- Current verified local gates: `python -m pytest tests -q` passes with 946
...
- Current primary risk: no active P1 defect from v1.0, Opus v2.0, or Opus v2.1
  ...
  boundary updates. The current Opus handoff is
  `docs/opus-review/HANDOFF.md`; the Historical Opus v2026-05-31 returned
  review packet remains under `claude-review/docs/v2026-05-31/`, the
  Historical Opus v2.1 review packet remains under
  `claude-review/docs/v2026-05-28/`, the Historical Opus v2.0 review packet
  remains under
  `claude-review/docs/v2026-05-26/`, and the live risk ledger is
