...
@pytest.mark.parametrize(
    ...
    [
        ("fallback_actions", "keep_current_replicas", "stage_interface_invalid=observe.fallback_actions"),
        ("fallback_modes", "keep_current_value", "stage_interface_invalid=observe.fallback_modes"),
        (
